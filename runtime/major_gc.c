                                    ...
                                    int may_access_gc_phase)
{
  ...
  */
  ...
  if (offheap_work > clamp) {
    CAML_GC_MESSAGE(SLICE, "Work clamped to %"
  ...
  CAML_GC_MESSAGE(SLICE,
                  ...
                  alloc_work, dependent_work,
                  my_dependent_count,
                  extra_work,
                  (uintnat)dom_st->extra_heap_resources,
                         ...
                         int force_alive)
{
  ...
  caml_gc_log("Mark Ephemeron: %s. Ephemeron cycle=%"ARCH_INTNAT_PRINTF_FORMAT"d "
    ...
    if (caml_stat_space_overhead.heap_words_last_cycle != 0) {
      ...
      */
      ...
      caml_stat_space_overhead.l->buffer[caml_stat_space_overhead.index++] =
        space_overhead;
      CAML_GC_MESSAGE(SLICE,
                      "Previous cycle's space_overhead: %lf\n", space_overhead);
    }
